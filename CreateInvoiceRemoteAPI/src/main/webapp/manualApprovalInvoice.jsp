...
function submitForm(resultVal){
	document.getElementById("manualApprovalResult").value = resultVal;
	//alert(document.getElementById("manualApprovalResult").value);
...
<p>Seller Approve Invoice</p>
	...
	<input type="hidden" name="activity" value="manualApprovalInvoiceSubmit">
	<input type="hidden" name="manualApprovalResult" id="manualApprovalResult">
	<input type="button" name="Submit" value="Approve" onclick="submitForm('Approved');" />&nbsp;&nbsp; 
